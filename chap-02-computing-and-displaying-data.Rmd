...
$$
\delta = - \arcsin{\left[\sin{\epsilon_0} \cos{\left(\dfrac{360^\circ}{365.24}(N + 10)\right) }\right]}
$$
...
Resultado: Declinação do Sol em 20 de junho de 2020: $\delta = `r format((180/pi)*py$delta, nsmall=2, digits=2, decimal.mark=",")`^\circ$
